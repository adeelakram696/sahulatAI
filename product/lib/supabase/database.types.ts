  ...
  public: {
    Tables: {
      agent_traces: {
        ...
        Relationships: [
          {
            foreignKeyName: "agent_traces_parent_step_id_fkey"
      ...
      bookings: {
        ...
        Relationships: [
          {
            foreignKeyName: "bookings_customer_user_location_id_fkey"
            columns: ["customer_user_location_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "bookings_service_category_fkey"
      ...
      mock_messages: {
        ...
        Relationships: [
          {
            foreignKeyName: "mock_messages_booking_id_fkey"
            columns: ["booking_id"]
            isOneToOne: false
      ...
      users_profile: {
        ...
        Relationships: [
          {
            foreignKeyName: "users_profile_default_location_fk"
    ...
    Functions: {
      ...
      sweep_expired_invitations: { Args: never; Returns: undefined }
